...
> 저는 이분말이 잘 이해가 되지 않아요 이게 어떻게 사업아이템이 될수있을까요 하하하..<br>진짜 이러면 정말 힘드네요 ㅎㅎ<br>
> 아무목적이란게  없어요....아 그렇진 않네요<br>
>
> 불편한걸 참지 못하고 <br>
>
> 더 나은방향으로 바뀔때 행복하고 희열을 느끼기때문에 그런것 같습니다. <br>
>
> <br>
>
> 그리고 댓글기능을 쓰면 좋을것 같은데 제가 직접 github에다가 minimalmistake라는 테마를 가지고 자체 호스팅을 하는 블로그라서<br>
> 댓글기능을 넣으려면 또 많은 커스터마이징이 필요하기때문에도 그렇고 DB화도 번거롭고 그래서 안하고 있습니다<br>
>
> 하지만 조만간 하도록하겠습니다!
